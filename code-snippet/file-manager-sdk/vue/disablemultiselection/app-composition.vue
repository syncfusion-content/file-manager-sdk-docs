<template>
    <div id="app">
        <ejs-filemanager id="file-manager" :allowMultiSelection="allowMultiSelection" :showItemCheckBoxes="showItemCheckBoxes" :ajaxSettings="ajaxSettings">
        </ejs-filemanager>
    </div>
</template>
<script setup>
...
const showItemCheckBoxes = false;
