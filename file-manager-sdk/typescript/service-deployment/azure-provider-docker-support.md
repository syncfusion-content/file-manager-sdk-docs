---
layout: post
title: Azure Docker Support in TypeScript File Manager | Syncfusion
description: Learn how to deploy the TypeScript File Manager Azure file provider using the pre-built Docker image and required Azure Blob Storage settings.
...
# Azure Provider Docker Support in TypeScript File Manager
