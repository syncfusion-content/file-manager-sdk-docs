---
layout: post
title: Amazon S3 Docker Support in TypeScript File Manager | Syncfusion
description: Learn how to deploy the TypeScript File Manager Amazon S3 file provider using the pre-built Docker image and required Amazon S3 settings.
...
Set the [`url`](https://ej2.syncfusion.com/documentation/api/file-manager/ajaxsettingsmodel#url), [`uploadUrl`](https://ej2.syncfusion.com/documentation/api/file-manager/ajaxsettingsmodel#uploadurl), [`downloadUrl`](https://ej2.syncfusion.com/documentation/api/file-manager/ajaxsettingsmodel#downloadurl), and [`getImageUrl`](https://ej2.syncfusion.com/documentation/api/file-manager/ajaxsettingsmodel#getimageurl) properties in the client-side File Manager control:
...
For more information on how to get started with the File Manager control, refer to this [Getting Started](../getting-started) page.
