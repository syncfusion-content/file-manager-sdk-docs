---
layout: post
title: Perform custom sorting in TypeScript File Manager | Syncfusion
description: Learn how to perform custom sorting in the TypeScript File Manager for the Large Icons view and Details view columns, with examples for natural sorting.
...
# How to perform custom sorting in TypeScript File Manager
...
{% include code-snippet/file-manager-sdk/typescript/customsorting-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/file-manager-sdk/typescript/customsorting-cs1/index.html %}
{% endhighlight %}
{% highlight css tabtitle="index.css" %}
{% include code-snippet/file-manager-sdk/typescript/customsorting-cs1/index.css %}
{% endhighlight %}
{% endtabs %}

{% previewsample "https://help.syncfusion.com/code-snippet/file-manager-sdk/typescript/customsorting-cs1" %}

{% elsif page.publishingplatform == "javascript" %}

{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/file-manager-sdk/typescript/customsorting-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/file-manager-sdk/typescript/customsorting-cs1/index.html %}
{% endhighlight %}
