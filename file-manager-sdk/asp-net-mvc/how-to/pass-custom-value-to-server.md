---
layout: post
title: Pass Custom Values to Server in ASP.NET MVC File Manager | Syncfusion
description: Learn here all about How to pass custom value to server in ASP.NET MVC  File Manager control of Syncfusion Essential JS 2 and more.
...
# Pass custom value to server in ASP.NET MVC  File Manager control
