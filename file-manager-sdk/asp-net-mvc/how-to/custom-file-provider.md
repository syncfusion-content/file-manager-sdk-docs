---
layout: post
title: Implement a custom file provider in ASP.NET MVC File Manager | Syncfusion
description: Learn how to implement a custom file provider in the ASP.NET MVC File Manager using Node.js with Azure Blob Storage as the data source.
...
# How to implement a custom file provider in ASP.NET MVC File Manager
