...
# Access Control in ASP.NET MVC File Manager
...
{% include code-snippet/file-manager-sdk/asp-net-mvc/access-control/tagHelper %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/file-manager-sdk/asp-net-mvc/access-control/razor %}
{% endhighlight %}
{% endtabs %}
{% endif %}
