---
layout: post
title: Azure Docker Support in ASP.NET MVC File Manager | Syncfusion
description: Learn how to deploy the ASP.NET MVC File Manager Azure file provider using the pre-built Docker image and required Azure Blob Storage settings.
...
# Azure Provider Docker Support in ASP.NET MVC File Manager
