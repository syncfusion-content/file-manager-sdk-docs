---
layout: post
title: Downloading Syncfusion File Manager SDK Web Installer - Syncfusion
description: Learn how to download the Syncfusion File Manager SDK web installer from our website with a license.
...
# Downloading the Syncfusion File Manager SDK Web Installer

You can either download the licensed installer or try our trial installer depending on your license type.

> **Note:** A **web installer** is a small executable that downloads the required Syncfusion components at install time. It requires an active internet connection and **administrator** privileges on Windows. The Web Installer supports Windows 10, Windows 11, and Windows Server 2016 or later (x64). Ensure you have sufficient disk space for the components you intend to install.
...
6. Click the **Download** button (element 1 in the following screenshot) to get the Syncfusion File Manager SDK Web Installer.
...
7. After downloading, the Syncfusion File Manager SDK web installer can be unlocked using Syncfusion registered login credential.

You can also refer to the [**File Manager SDK Web Installer**](https://help.syncfusion.com/filemanager-sdk/installation/web-installer/how-to-install) link for step-by-step installation guidelines.
