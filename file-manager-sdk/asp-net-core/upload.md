...
{% include code-snippet/file-manager-sdk/asp-net-core/upload-feature-cs1/tagHelper %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/file-manager-sdk/asp-net-core/upload-feature-cs1/razor %}
{% endhighlight %}
{% endtabs %}
{% endif %}
