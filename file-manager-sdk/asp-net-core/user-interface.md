---
layout: post
title: User Interface in ASP.NET Core File Manager | Syncfusion
description: Learn how to use the ASP.NET Core File Manager UI with view, toolbar, breadcrumb, context menu, and navigation pane modules for file browsing.
...
# User Interface in ASP.NET Core File Manager
