---
layout: post
title: Add a custom item to the toolbar in ASP.NET Core File Manager | Syncfusion
description: Learn how to add a custom item to the toolbar in the ASP.NET Core File Manager to extend built-in actions with custom controls.
...
{% include code-snippet/file-manager-sdk/asp-net-core/how-to/toolbar/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="HomeController_core.cs" %}
{% include code-snippet/file-manager-sdk/asp-net-core/how-to/toolbar/HomeController_core.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/file-manager-sdk/asp-net-core/how-to/toolbar/razor %}
{% endhighlight %}
{% highlight c# tabtitle="HomeController_mvc.cs" %}
{% include code-snippet/file-manager-sdk/asp-net-core/how-to/toolbar/HomeController_mvc.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
