---
layout: post
title: Drag and Drop in React File Manager | Syncfusion
description: Learn how to enable drag and drop in the React File Manager to move or upload files between folders using built-in drag events.
