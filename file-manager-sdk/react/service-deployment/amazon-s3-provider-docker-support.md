---
layout: post
title: Amazon S3 Provider Docker Support in React File Manager | Syncfusion
description: Learn how to deploy the React File Manager Amazon S3 file provider using the pre-built Docker image and required Amazon S3 settings.
...
# Amazon S3 Provider Docker Support in React File Manager
...
Set the [`url`](https://ej2.syncfusion.com/react/documentation/api/file-manager/ajaxsettingsmodel#url), [`uploadUrl`](https://ej2.syncfusion.com/react/documentation/api/file-manager/ajaxsettingsmodel#uploadurl), [`downloadUrl`](https://ej2.syncfusion.com/react/documentation/api/file-manager/ajaxsettingsmodel#downloadurl), and [`getImageUrl`](https://ej2.syncfusion.com/react/documentation/api/file-manager/ajaxsettingsmodel#getimageurl) properties in the client-side File Manager component:
...
The following example shows a React client that configures the [`ajaxSettings`](https://ej2.syncfusion.com/react/documentation/api/file-manager/ajaxsettings) properties.
