...
## Customizing the React File Manager navigation pane

To customize the React File Manager navigation pane, use the `.e-navigation` selector and apply styles.
...
/*
 Set background color for the React File Manager navigation pane */
...
![React File Manager Customization Navigation Pane](./images/customize_navigation_pane.png)

## Customizing the React File Manager layout

To customize the React File Manager layout, use the `.e-layout-content` selector and apply styles. 
...
![React File Manager Customization Layout](./images/customize_layout.png)

## Customizing the File Manager thumbnail

To customize the thumbnails in the React File Manager, you can apply background-image styles to specific CSS selectors that represent different file types, as listed in the table below.
...
The following example demonstrates how to customize the React File Manager's thumbnail icon for folders:

```css

/* Applies to both Large Icons view and Details view in the React File Manager */
...
![React File Manager Customization Thumbnail](./images/customize_thumbnail.png)

## Customizing the React File Manager Toolbar

To customize the React File Manager toolbar items, use the `.e-toolbar` selector and apply styles.
...
![React File Manager Customization Toolbar](./images/customize_toolbar.png)

## Customizing the React File Manager selected files/folders

To customize the React File Manager selected files/folders, use the below selectors and apply styles.
...
![React File Manager Customization Selected File](./images/customize_selected_file.png)

## Customizing the React File Manager Dialog

To customize the dialog popup in the React File Manager, you can apply styles to specific CSS selectors, as listed below.
...
/* For React File Manager Dialog header */
...
```
![React File Manager Customization dialog](./images/customize_dialog.png)