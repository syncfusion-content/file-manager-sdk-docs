...
## 1. Setting up the Angular File Manager and provider

To create a basic Angular File Manager component, follow the steps in the [`Getting Started`](https://ej2.syncfusion.com/angular/documentation/file-manager/getting-started) guide. This will allow you to manage files and folders stored either physically or in the cloud.

For connecting the Angular File Manager to a physical file system, refer to the [`Physical file provider`](https://ej2.syncfusion.com/angular/documentation/file-manager/file-system-provider#physical-file-system-provider) section. This part of the documentation will help you configure it correctly.

## 2. Handling File Operations 

After setting up the Angular File Manager component with the physical file system provider, you can handle file operations by passing custom values to the server. To pass custom values during the **Read**, **Delete**, **Rename**, **Create**, **Move**, **Copy**, **Details**, **Search**, and **Upload**, use the [`beforeSend`](https://ej2.syncfusion.com/angular/documentation/api/file-manager#beforesend) event of the Angular File Manager component. This event allows you to modify the request before it is sent to the server. You can add custom headers to the request to pass additional information to the server.
...
For the **GetImage** operation, use the [`beforeImageLoad`](https://ej2.syncfusion.com/angular/documentation/api/file-manager#beforeimageload) event. Inside this event, set [`useImageAsUrl`](https://ej2.syncfusion.com/angular/documentation/api/file-manager/beforeImageLoadEventArgs#useImageAsUrl) to false to instruct the Angular File Manager not to load the image directly via its URL but instead to use a fetch request. Here, attach the **Authorization** header with the value **User1** within the beforeSend event of the ajaxSettings.
