---
layout: post
title: Multiple Selection in Vue File Manager | Syncfusion
description: Learn how to enable multiple selection in the Vue File Manager using Ctrl/Shift keys and checkboxes to select many files at once.
...
>Note: The Vue File Manager has support to select files and folders initially or dynamically by specifying their names in [selectedItems](https://ej2.syncfusion.com/vue/documentation/api/file-manager#selecteditems) property.

## Range selection

The Vue File Manager supports selecting files and folders in specific ranges using mouse drag, similar to File Explorer. This is particularly useful in scenarios where users need to select a large group of files quickly without manually clicking each one. 
