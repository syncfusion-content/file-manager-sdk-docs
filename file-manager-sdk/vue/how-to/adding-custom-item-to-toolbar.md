---
layout: post
title: Add a custom item to the toolbar in Vue File Manager | Syncfusion
description: Learn how to add a custom item to the toolbar in the Vue File Manager to extend built-in actions with custom controls.
