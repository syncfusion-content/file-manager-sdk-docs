---
layout: post
title: Pass a custom value to the server in JavaScript File Manager | Syncfusion
description: Learn how to pass a custom value to the server in the JavaScript File Manager for authentication, logging, or role-based access on each request.
...
# How to pass a custom value to the server in JavaScript File Manager
